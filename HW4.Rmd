...
These results are based on the assumptions of the linear model being satisfied, which we see below, that is not the case. In the diagnostic plots in 4, we saw severe violations of the linearity assumption.   
